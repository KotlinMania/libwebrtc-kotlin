...
This file is the quick-reference operating contract for libwebrtc-kotlin. The longer
...
libwebrtc-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`libwebrtc`](https://crates.io/crates/libwebrtc). Upstream Rust is the behavioral oracle while the
