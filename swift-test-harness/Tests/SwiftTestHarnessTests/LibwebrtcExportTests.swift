...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Libwebrtc.swiftmodule/`
...
//      `import Libwebrtc` above would fail at compile time.
//
//   2. The static archive `libLibwebrtc.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Libwebrtc" }` and
//      `flattenPackage = "io.github.kotlinmania.libwebrtc"` configuration in
...
//      via the `LibwebrtcLibrary` product.
//
...
final class LibwebrtcExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Libwebrtc swift module imported cleanly")
    }
}
