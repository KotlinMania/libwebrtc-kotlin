# libwebrtc-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Flibwebrtc--kotlin-blue.svg)](https://github.com/KotlinMania/libwebrtc-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/libwebrtc-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/libwebrtc-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/libwebrtc-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/libwebrtc-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`livekit/rust-sdks`](https://github.com/livekit/rust-sdks).

**Original Project:** This port is based on [`livekit/rust-sdks`](https://github.com/livekit/rust-sdks). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
## Upstream README — `livekit/rust-sdks`

> The text below is reproduced and lightly edited from [`https://github.com/livekit/rust-sdks`](https://github.com/livekit/rust-sdks). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
```kotlin
dependencies {
    implementation("io.github.kotlinmania:libwebrtc-kotlin:0.1.0-SNAPSHOT")
}
```
...
This Kotlin port is distributed under the same Apache-2.0 license as the upstream [`livekit/rust-sdks`](https://github.com/livekit/rust-sdks). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.
...
Thanks to the [`livekit/rust-sdks`](https://github.com/livekit/rust-sdks) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
